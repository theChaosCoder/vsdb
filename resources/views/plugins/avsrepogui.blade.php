...
<div class="ui two column centered grid">
    <div class="column">
        <div class="ui message">
            <div class="header">
                AVSRepo - A simple Avisynth+ plugin manager
            </div>
            <p>More info on <a href="https://forum.doom9.org/showthread.php?t=175822">doom9.org</a>, Source on <a href="https://github.com/theChaosCoder/avsrepo">Github</a>.</p>
            <p>Download the latest version here: <a href="https://github.com/theChaosCoder/avsrepo/releases">avsrepo</a></p>
        </div>
    </div>
</div>
			...
			<tbody>
				...
				<tr data-child-value='<td colspan="9">
						<div class="ui four column very relaxed grid">
							...
							<div class="column ui raised">
								...
								<div class="ui icon message">
									...
									<div class="content">
										<div class="header">
											AVSRrepo is available
										</div>
										<p>Install with: <b>avsrepo install @if(isset($plugin['namespace'])) {{ $plugin['namespace'] }} @else {{ $plugin['modulename'] }} @endif</b></p>
									</div>
								</div>
                    ...
                    <td class="center aligned">
						@if ($plugin['type'] == "PyScript" || $plugin['type'] == "avsiScript")
